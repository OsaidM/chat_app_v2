...
function countColumn(arr){  
    // this function still not ready trying to think of a way
...
function countCross(){ 
    // this function counts Cross Columns
    var crossCount = 0;
    var counter = 0;
    for(var i =0;i < arr.length;i++){
        if(arr[i][i] == -1){
...
function winCondition(arr,bingo){
    ...
    for(var i=0;i < sumOfColumnsRowsCross; i++){ 
        //this way does some duplications in the HTML Page
